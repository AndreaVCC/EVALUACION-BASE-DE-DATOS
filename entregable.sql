...
SELECT test.test_id AS "TEST ALERNAT INCORRECTAS", test.test_nombre, x.respuesta_pregunta_id, x.nro_alternativas, NVL(x.nro_true,0), NVL(x.nro_false,0) nro_false
FROM (
WITH
